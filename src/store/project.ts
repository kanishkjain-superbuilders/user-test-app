...
interface ProjectState {
  ...
  createProject: (orgId: string, name: string, description?: string) => Promise<Project | null>;
  createTestLink: (data: Database['public']['Tables']['test_links']['Insert']) => Promise<TestLink | null>;
  updateTestLink: (id: string, data: Database['public']['Tables']['test_links']['Update']) => Promise<void>;
